...
(function($){
	...
	$(function(){
		...
		// with easing
		// TweenMax.to($circle, 1, {left: 1000, ease: 'Power4.easeOut'});
		
		// yoyo
		// TweenMax.to($circle, 1, {left: 1000, ease: 'Power4.easeInOut', yoyo: true, repeat: 1});

		// 2d transform
		// TweenMax.to($circle, 1, {x: 1000});
		
		// 3d transform
		// TweenMax.to($circle, 1, {x: 1000, z: 0.1});
